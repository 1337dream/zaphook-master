...
public:
	...
	void DrawFRect(int x, int y, int w, int h, CColor colour) {
		this->DrawSetColor(colour._color[0], colour._color[1], colour._color[2], colour._color[3]);
		this->draw_filled_rectangle(x, y, w, h);
	}
