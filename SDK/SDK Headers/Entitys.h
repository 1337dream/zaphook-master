...
public:
	...
	int FlashDuration() {
		static int m_flFlashDuration = Netvar("DT_CSPlayer", "m_flFlashDuration");
		return *reinterpret_cast<int*>(uintptr_t(this) + m_flFlashDuration);
	}

	int money() {
		return *reinterpret_cast<int*>(uintptr_t(this) + 0xB238);
	}

	int GetLoadedAmmo()
	{

		static int m_iClip1 = Netvar("DT_BaseCombatWeapon", "m_iClip1");
	...
	int GetActiveWeaponIndex()
	{
		...
		static int m_hActiveWeapon = Netvar("DT_BaseCombatCharacter", "m_hActiveWeapon");
	...
	CAnimationLayer& GetAnimOverlayy(int Index)
	{
		return (*(CAnimationLayer**)((DWORD)this + 0x2980))[Index];
	}

	Vector* EasyEyeAngles()
	{
		static int m_angEyeAngles = Netvar("DT_CSPlayer", "m_angEyeAngles[0]");
	...
	{
		static int m_angEyeAngles = Netvar("DT_CSPlayer", "m_angEyeAngles[0]");
		*reinterpret_cast<Vector*>(uintptr_t(this) + m_angEyeAngles) = angles;
	}
