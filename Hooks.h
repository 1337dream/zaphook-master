...
public:
	...
	void Hook()
	{
		...
		Interfaces.pSurface->SetFontGlyphSet(Font_Controls, "Verdana", 10, 400, 0, 0, FONTFLAG_OUTLINE);
		...
		Interfaces.pSurface->SetFontGlyphSet(Font_ESP, "Verdana", 12, 700, 0, 0, FONTFLAG_DROPSHADOW);
		Interfaces.pSurface->SetFontGlyphSet(Font_HUD, "Tahoma", 16, 600, 0, 0, FONTFLAG_ANTIALIAS);
		Interfaces.pSurface->SetFontGlyphSet(Font_LBY, "Verdana", 28, 650, 0, 0, FONTFLAG_DROPSHADOW | FONTFLAG_ANTIALIAS);
